...
Municipality of Salcedo<br>
 ...
 if(isset($_POST["skvoter"]))
    ...
    when (TIMESTAMPDIFF(Month,res_Bday,CURDATE())>=15 and TIMESTAMPDIFF(Month,res_Bday,CURDATE())<=17) then 'SK Voters'
       end) Age_Stage 
    ...
    LEFT JOIN ref_occupation ro ON rd.occupation_ID = ro.occupation_ID 
    LEFT JOIN ref_occupation_status ros ON rd.occuStat_ID = ros.occuStat_ID 
    LEFT JOIN ref_country rc ON rd.country_ID = rc.country_ID WHERE TIMESTAMPDIFF(YEAR,res_Bday,CURDATE())  BETWEEN '15' AND '17'";
    $result = mysqli_query($db, $query);
     if(mysqli_num_rows($result) > 0)
     {
      $output .= '
    ...
    Municipality of Salcedo<br>
      ...
      $output .= '</table> <br><br><br><br>Prepared By:<br><br> <br>
       ...
       Position:';
      header('Content-Type: application/xls');
      header('Content-Disposition: attachment; filename=SK-Voter-Resident-report.xls');
      echo $output;
    }
    }   
