...
res_fName, res_mName,res_lName,suffix_ID, gender_ID, res_Bday, voter_status, marital_ID,religion_ID,res_Height,res_Weight, occuStat_ID,occupation_ID,country_ID,Status) VALUES('$rid','$file','$res_fname','$res_mname','$res_lname','$res_suffix','$res_gender','$res_bdate', '$voter_status', '$res_civilstatus','$res_religion','$res_height', '$res_weight','$res_occupationstatus','$res_occupation','$res_citizenship','Active') ");
    echo "<script type='text/javascript'>alert('submitted successfully!')</script>";
        ...
        if ($rid  && $res_citizenship){
          ...
          if ( $rid && $res_houseno && $res_street){
             $query=mysqli_query($db,"INSERT INTO resident_address(address_ID,res_ID,address_House_No,address_Street_Name,country_ID,region_ID) VALUES('$aid','$rid','$res_houseno','$res_street','$res_citizenship','$res_region') ");
...
<div class="form-group col-md-4">
  ...
  <select required class="form-control" id="res_gender" name="res_gender">
    ...
    <input  placeholder="Birthdate"  required class="form-control" type="date"  id="res_bdate" name="res_bdate" onblur="getAge_Voterstatus();" >
  </div>
...
function getAge_Voterstatus(){
    ...
    if (age >= 0 && age <= 13) {
        document.getElementById('res_voter').value = "Non Voter";
    } else if (age >= 15 && age <= 17) {
        document.getElementById('res_voter').value = "SK Voter";
    } else if (age >= 18) {
        document.getElementById('res_voter').value = "Barangay Voter";
    }
